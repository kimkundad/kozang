                  ...
                  <br>
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control" name="email" placeholder="Email Address" required autofocus value="{{ $email ?? old('email') }}">
                                @error('email')
                        ...
                        <div class="form-group">
                            <div class="col-md-12 ">
                                <button type="submit" class="btn btn-primary btn-block">
                                    <i class="fa fa-btn "></i> {{ __('Reset Password') }}
                                </button>
                            </div>
                        </div>
