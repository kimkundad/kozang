				...
				<div class="row feature_home_2">
                    <div class="col-md-4 text-center">
                      ...
                      <h3><span>+120k</span> ร้านวัสดุก่อสร้าง</h3>
                        <p style="font-size: 13px;">รวบรวมร้านวัสดุก่อสร้างทั่วประเทศ มีข้อมูลสามารถติดต่อและรายละเอียด รวมทั้งตำแหน่งที่ตั้ง อำนวยความสะดวกในการค้นหาร้านวัสดุก่อสร้างได้อย่างรวดเร็ว</p>
                    </div>
                    <div class="col-md-4 text-center">
                    <div class="feature_home_x">
                      ...
                      <h3><span>+ 1000</span> ผู้ใช้งาน</h3>
                        <p style="font-size: 13px;"> มีผู้ใช้งานหลากหลายกลุ่ม ทั้งคนทั่วไป ช่างรับเหมา ผู้รับเหมา หน่วยงานจัดซื้อ และโครงการต่างๆ เป็นช่องทางที่ดีสำหรับร้านค้าวัสดุก่อสร้างที่จะเข้าถึงกลุ่มลูกค้าได้หลากหลาย เพียงลงข้อมูลกับทางเรา</p>
                    </div>
                    <div class="col-md-4 text-center">
                    <div class="feature_home_x">
                      ...
                      <h3><span>ติดต่อ</span> ร้านค้าเพิ่ม</h3>
                        <p style="font-size: 13px;">ร้านค้าวัสดุก่อสร้างที่ต้องการลงข้อมูล หรือแก้ไขข้อมูลต่างๆ เพื่อเพิ่มโอกาสในการเข้าถึงลูกค้าและเพิ่มยอดขาย สามารถติดต่อทางเราได้โดยตรง</p>
                    </div>
                </div>
                <br><br>
