    ...
    <td>
    	<!-- Start Space -->
			<table width="100%" bgcolor="#e8e8e8" cellspacing="0" cellpadding="0" border="0" class="full-width" >
				<tbody>
					<tr>
						<td height="28" align="center" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#7f8c8d;"></td>
					</tr>
				</tbody>
			</table>
		<!-- End Space -->
						...
						<tr>
                            ...
                            <!-- Start Space -->
								...
								<!-- Section 1 Starts / Logo social ================  -->
									...
									<table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" bgcolor="#ffffff">
									<tbody>
										<tr>
											<td height="26">&nbsp;</td>
										</tr>
										<tr>
											<td height="25" valign="middle" align="center">
												...
												<table  align="center" cellspacing="0" cellpadding="0" border="0" class="full-width">
													<tbody>
														<tr>
															 <td align="center"><img src="{{url('assets/img/logo_sticky.png')}}"  height="80"/></td>
																		...
																		<td align="center">
																			...
																			<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
																				<tbody>
																					...
																					<tr>
																						<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;" align="left">
																							<br />
																						สวัสดีค่ะ {{$name}}</td>
																					</tr>
																					<tr>
																					...
																					<tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
																							Please press the "reset password" button to create a new password. <br /> www.teeneejj.com</td>
																					</tr>
																					<tr>
																					...
																					<tr>
																						<td align="center">
																							<table cellspacing="0" cellpadding="0" border="0" align="center">
																								<tbody>
																									<tr>
																										<td align="center" style="border-radius:3px;color: #1b1717;display:block;font-family: Arial, Helvetica, sans-serif;font-size:12px;line-height:12px;text-align:center;text-decoration:none;padding-top: 10px;padding-bottom: 10px;width:110px;-webkit-text-size-adjust:none;background-color: #ffd430;">
																											<a style="color: #0e0a0a;font-family: Arial, Helvetica, sans-serif;font-size:12px;text-decoration:none !important;" href="{{$url}}">Reset Password</a>
																										</td>
																									</tr>
																								</tbody>
																							</table>
																					...
																					<tr >
																						<td style="font-size:12px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
																							<hr />
																							If you can't click the "Reset Password" button, you can copy and paste the URL below in the browser. <a href="{{$url}}">{{$url}}</a>.</td>
																					</tr>
                                                                                    <tr>
																						<td height="30">&nbsp;</td>
																					</tr>
																...
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px">
																			<strong>Copyright © 2020 teeneejj.com</strong><br />
																		</td>
																	</tr>
																</tbody>
															</table>
...
<td>
	...
	<table width="100%" bgcolor="#e8e8e8" cellspacing="0" cellpadding="0" border="0" class="full-width" >
		<tbody>
			<tr>
				<td height="65" align="center" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#7f8c8d;"></td>
			</tr>
		</tbody>
	</table>
<!-- End Space -->
