    ...
    <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
              <div id="logo">
                  <a href="{{url('/')}}"><img src="{{url('img/logo.png')}}" height="54" alt="TEENEEJJ" data-retina="true" class="logo_normal"></a>
                  <a href="{{url('/')}}"><img src="{{url('img/logo_2.png')}}" height="54" alt="TEENEEJJ" data-retina="true" class="logo_sticky"></a>
              </div>
          </div>
            <nav class="col-md-9 col-sm-9 col-xs-9">
                ...
                <div class="main-menu">
                    <div id="header_menu">
                        <img src="{{url('img/logo.png')}}" height="54" alt="City tours" data-retina="true">
                    </div>
                    ...
                    <ul>
                      ...
                      <li>
                          <a style="font-size: 15px;" href="{{url('/about_us')}}">เกี่ยวกับเรา </a>
